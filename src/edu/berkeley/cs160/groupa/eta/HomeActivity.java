...
//	    mApptAdapter.changeCursor(null);
	...
	public void createTestData() {
		...
		values.put(ApptColumns.NAME, "Howard Guan");
		values.put(ApptColumns.PHONE, "510-508-9476");
		values.put(ApptColumns.DATE, "Wednesday, 12/11/13");
		values.put(ApptColumns.FROM, "11:15 AM");
		values.put(ApptColumns.TO, "12:15 PM");
		values.put(ApptColumns.LOCATION, "650 California Street, San Francisco, CA, United States");
		...
		values.put(ApptColumns.PHONE, "510-735-7185");
		values.put(ApptColumns.DATE, "Wednesday, 12/11/13");
		values.put(ApptColumns.FROM, "12:16 PM");
		values.put(ApptColumns.TO, "01:15 PM");
		values.put(ApptColumns.LOCATION, "844 Haight Street, San Francisco, CA, United States");
		values.put(ApptColumns.AM_PM, "PM");
		values.put(ApptColumns.TWELVE, "A");
		getContentResolver().insert(ApptContentProvider.CONTENT_URI, values);
		values.put(ApptColumns.NAME, "Tom Hird");
		values.put(ApptColumns.PHONE, "858-200-6191");
		values.put(ApptColumns.DATE, "Wednesday, 12/11/13");
		values.put(ApptColumns.FROM, "01:16 PM");
		values.put(ApptColumns.TO, "02:15 PM");
		values.put(ApptColumns.LOCATION, "2651 Rollingwood Drive, San Bruno, CA, United States");
		values.put(ApptColumns.AM_PM, "PM");
		values.put(ApptColumns.TWELVE, "B");
		getContentResolver().insert(ApptContentProvider.CONTENT_URI, values);
		values.put(ApptColumns.NAME, "Michelle Chow");
		values.put(ApptColumns.PHONE, "858-335-9258");
		values.put(ApptColumns.DATE, "Wednesday, 12/11/13");
		values.put(ApptColumns.FROM, "02:16 PM");
		values.put(ApptColumns.TO, "03:15 PM");
		values.put(ApptColumns.LOCATION, "7251 Brentwood Boulevard, Brentwood, CA, United States");
		values.put(ApptColumns.AM_PM, "PM");
		values.put(ApptColumns.TWELVE, "B");
		getContentResolver().insert(ApptContentProvider.CONTENT_URI, values);
